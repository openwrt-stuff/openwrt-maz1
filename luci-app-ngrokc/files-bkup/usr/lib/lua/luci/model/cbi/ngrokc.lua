...
custom_domain.anonymous = true
custom_domain.addremove = false

sdname=tunnels:option(Value, "sdname", translate("Custom Domain/Subdomain"), translate("If you enabled \"Use Custom Domain\", please set your domain's CNAME or A record to the tunnel server."))
